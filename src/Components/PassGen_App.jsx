...
class PassGen_App extends Component{
	...
	<div className="container">
		<div className="row">
			...
			<button className="buttons" width= "100%" height="auto" id="btn" onClick={this.genPass}  >Generate New Password!</button>
			<input className="input-field pt-2 pr-2 mt-2" id="myNewPassword" readOnly value={this.state.generatedPass} />
			<button className="buttons" width= "100%" height="auto" id="Copybtn" onClick={this.copyFnc} >Copy Password</button>
		</div>
	</div>
		)
	}
